# -*- coding: utf-8 -*-
"""
Created on Mon Jan  2 18:26:16 2023
...
# Create an AdaBoost classifier using the SVM as the base classifier
adaboost_svm = AdaBoostClassifier(base_estimator=svm, n_estimators=100)
...
accuracy = adaboost_svm.score(X_test, y_test)
